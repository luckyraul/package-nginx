...
RUN git clone --depth=1 https://github.com/google/ngx_brotli.git && cd ngx_brotli && \
  ...
  rm -fR deps/brotli/tests deps/brotli/research/img deps/brotli/java deps/brotli/docs/brotli-comparison-study-2015-09-22.pdf deps/brotli/c/common/dictionary.bin.br deps/brotli/js/test_data.tar && \
